    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div id="project" class="thumbnail box-about">
                ...
                <b><p class="h-box-about" >โครงการของ<?= $name->type->type_th?> ประจำปี <?php echo $year; ?></p></b>
                <?php foreach($model as $pro) { ?>
                
                <a target ="_blank" href="document/projects/<?php echo $pro->docs?>"> <i style="color:#999999" class="fa fa-download" aria-hidden="true"></i> <?php echo $pro->projectname_th?> </a><br>
